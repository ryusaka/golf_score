    ...
    <div>
      <div className={classes.main}>
        ...
        <div className={classes.scoreElem}>
          <IconButton
            disabled={score.scores[hole - 1].stroke <= 1}
            onClick={() => props.decrement(player, hole)}
            color='secondary'
          >
            <MinusIcon className={classes.scoreButtonIcon} />
          </IconButton>
          <div className={classes.score}>{score.scores[hole - 1].stroke}</div>
          <IconButton onClick={() => props.increment(player, hole)} color='secondary'>
            <PlusIcon className={classes.scoreButtonIcon} />
          </IconButton>
        </div>
      </div>
